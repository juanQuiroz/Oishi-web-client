...
export default function ModalComprarOferta({
  isOpen,
  setIsOpen,
  presentacionOferta,
  dataProducto,
  ...
  React.useEffect(() => {
    ...
    addOferta({
      producto_nombre: dataProducto.nombre,
      cantidad: cantPresentacionOferta,
      oferta_id: presentacionOferta.oferta_id,
                ...
                {presentacionOferta && (
                  <div className="">
                    ...
                    <div className="m-3">
                      ...
                      <p className="text-xl text-gray-600 font-bold font-Andika">
